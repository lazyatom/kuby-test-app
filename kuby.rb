...
Kuby.define('KubyTestApp') do
  environment(:production) do
    ...
    docker do
      ...
      image_url 'registry.gitlab.com/lazyatom/kuby-test-app'
      # image_url 'docker.pkg.github.com/lazyatom/kuby-test-app/kuby-test-app'
    end

    kubernetes do
      # Add a plugin that facilitates deploying a Rails app.
      add_plugin :rails_app do
        hostname 'kuby-test-app.exciting.io'
